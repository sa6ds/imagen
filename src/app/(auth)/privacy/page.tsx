  ...
  return (
    <div className="min-h-[100vh]">
      <div className="container mx-auto px-12 py-12">
        <Navbar />
        <main className="container mx-auto max-w-4xl px-5">
          <h1 className=" text-3xl tracking-tight sm:text-2xl md:text-3xl lg:text-4xl text-slate-900 font-bold dark:text-white mt-12">
            Privacy Policy
          </h1>
          <p className=" text-slate-700 dark:text-slate-400 whitespace-pre-line leading-relaxed mt-6">
            At Imagen, accessible from www.Imagen.lol, one of our main
            priorities is the privacy of our visitors. This Privacy Policy
            document contains types of information that is collected and
            recorded by Imagen and how we use it. If you have additional
            ...
            Imagen. This policy is not applicable to any information collected
          ...
          <p className=" text-slate-700 dark:text-slate-400 whitespace-pre-line mt-3">
            Imagen follows a standard procedure of using log files. These files
          ...
          <p className=" text-slate-700 dark:text-slate-400 whitespace-pre-line mt-3">
            Like any other website, Imagen uses &apos;cookies&apos;. These
          ...
          <p className=" text-slate-700 dark:text-slate-400 whitespace-pre-line mt-3">
            ...
            advertising partners of Imagen. Third-party ad servers or ad
            ...
            appear on Imagen, which are sent directly to users browser. They
            automatically receive your IP address when this occurs. These
            technologies are used to measure the effectiveness of their
            advertising campaigns and/or to personalize the advertising content
            that you see on websites that you visit. Note that Imagen has no
          ...
          <p className=" text-slate-700 dark:text-slate-400 whitespace-pre-line mt-3">
            ...
            protection rights. The right to access - You have the right to
            request copies of your personal data. We may charge you a small fee
            for this service. The right to rectification - You have the right to
            ...
            you believe is incomplete. The right to erasure - You have the right
            ...
            certain conditions. The right to data portability - You have the
          ...
          <p className=" text-slate-700 dark:text-slate-400 whitespace-pre-line mt-3">
            ...
            Imagen does not knowingly collect any Personal Identifiable
