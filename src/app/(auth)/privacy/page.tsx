...
const Privacy = () => {
  return (
    <main className="container mx-auto px-16 py-12 max-w-4xl">
      ...
      <p className=" -pre-line leading-relaxed mt-6">
        ...
        in Imagen. This policy is not applicable to any information collected
        offline or via channels other than this website. Our Privacy Policy was
      ...
      <p className=" -pre-line mt-3">
        ...
        in their respective advertisements and links that appear on Imagen,
        ...
        that Imagen has no access to or control over these cookies that are used
      ...
      <p className=" -pre-line mt-3">
        ...
        incomplete. The right to erasure - You have the right to request that we
        erase your personal data, under certain conditions. The right to
        restrict processing - You have the right to request that we restrict the
