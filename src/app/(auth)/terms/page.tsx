    ...
    <div className="min-h-[100vh]">
      <div className="container mx-auto px-12 py-12">
        ...
        <main className="container mx-auto max-w-4xl px-5">
          <h1 className="text-3xl tracking-tight font-bold sm:text-2xl md:text-3xl lg:text-4xl text-slate-900 dark:text-white mt-12">
            Terms and Conditions
          </h1>
          <p className="text-slate-700 dark:text-slate-400 whitespace-pre-line leading-relaxed mt-6">
            These terms and conditions outline the rules and regulations for the
            use of Imagen&apos;s Website, located at{" "}
            <Link
              className="text-orange-500 dark:text-orange-400 underline"
              href="https://www.imagen.lol"
            >
              https://www.imagen.lol
            </Link>
            . By accessing this website we assume you accept these terms and
            conditions. Do not continue to use Imagen if you do not agree to
          ...
          <p className="text-slate-700 dark:text-slate-400 whitespace-pre-line mt-3 leading-relaxed">
            ...
            Imagen for your own personal use subjected to restrictions set in
          ...
          <p className="text-slate-700 mt-5 dark:text-slate-400 whitespace-pre-line leading-relaxed">
            ...
            Imagen does not filter, edit, publish or review Comments prior to
            their presence on the website. Comments do not reflect the views and
            opinions of Imagen, its agents and/or affiliates. Comments reflect
            the views and opinions of the person who post their views and
            opinions. To the extent permitted by applicable laws, Imagen shall
            not be liable for the Comments or for any liability, damages or
            expenses caused and/or suffered as a result of any use of and/or
            posting of and/or appearance of the Comments on this website. Imagen
            reserves the right to monitor all Comments and to remove any
            Comments which can be considered inappropriate, offensive or causes
            breach of these Terms and Conditions. You warrant and represent
            that:
          </p>
          <ul className="list-disc list-inside leading-relaxed text-slate-700 mt-5 dark:text-slate-400">
            <li>
          ...
          <p className="text-slate-700 mt-5 dark:text-slate-400 whitespace-pre-line leading-relaxed">
            You hereby grant Imagen a non-exclusive license to use, reproduce,
            edit and authorize others to use, reproduceand edit any of your
          ...
          <p className="text-slate-700 mt-5 dark:text-slate-400 whitespace-pre-line leading-relaxed">
            ...
            visibility of the hyperlink compensates the absence of Imagen; and
          ...
          <p className="text-slate-700 mt-5 dark:text-slate-400 whitespace-pre-line leading-relaxed">
            ...
            sending an e-mail to Imagen. Please include your name, your
          ...
          <p className="text-slate-700 mt-5 dark:text-slate-400 whitespace-pre-line leading-relaxed">
            Wait 2-3 weeks for a response. Approved organizations may hyperlink
