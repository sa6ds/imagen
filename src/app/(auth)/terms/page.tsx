  ...
  return (
    <main className="container mx-auto px-16 py-12 max-w-4xl">
      ...
      <p className=" whitespace-pre-line leading-relaxed mt-6">
        ...
        conditions. Do not continue to use Imagen if you do not agree to take
      ...
      <p className="mt-5 whitespace-pre-line leading-relaxed">
        ...
        of Imagen, its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, Imagen shall not be liable for the
        ...
        of the Comments on this website. Imagen reserves the right to monitor
      ...
      <p className=" whitespace-pre-line leading-relaxed mt-5">
        ...
        be interpreted as libelous, obscene, criminal, or which infringes,
