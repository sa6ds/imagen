        ...
        <main className="flex items-center justify-center">
          <div className="mt-24 lg:mt-44 lg:text-center lg:mx-5 flex flex-col justify-center">
            <div className="relative z-50">
              ...
              <Link
                href="/generate"
                className="relative border-grey-100 mx-auto rounded-lg border-b-4 border-orange-700 bg-gradient-to-b from-orange-500 to-red-500 px-8 py-2 text-white ease-in-out"
              >
                Try for free
